...
Tutte power seris for a metric graph with arbitrary positive real edge lengths, 
...
vary the metric graph over a natural moduli space.
...
The function $\ev(1,1)$ is continuous on $\Mgraphg$, 
