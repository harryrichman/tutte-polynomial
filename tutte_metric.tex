...
\begin{document}
\title[Tutte power series on metric graphs]
...
and
$\displaystyle
\binom{\alpha}{k} \coloneq \frac1{k!}\alpha(\alpha - 1) \cdots (\alpha - k + 1)$.
...
$
(1 + u)^\alpha 
% &= u \left(\frac{(1+u)^\alpha - 1}{u}\right) + 1  \\
...
The moduli space of genus $g$ metric graphs is a polyhedral fan
