...
% Tutte power series 
for a metric graph with arbitrary positive real edge lengths, 
...
Other Tutte polynomial evaluations include counts of acyclic orientations, totally cyclic orientations, connected subgraphs, and acyclic subgraphs.
...
As a consequence, the Tutte evaluation at a chosen $(x, y)$ (often) defines a continuous function on the space of metric graphs of fixed genus.
\begin{thm}
